...
import com.waitou.wisdao_lib.call.ILoaderAlbumCall
import com.waitou.wisdao_lib.call.ILoaderMediaCall
import com.waitou.wisdao_lib.call.OnResultMediaListener
import com.waitou.wisdao_lib.config.WisdomConfig
import com.waitou.wisdao_lib.loader.AlbumCollection
import com.waitou.wisdao_lib.loader.MediaCollection
import com.waitou.wisdao_lib.utils.CameraStrategy

/**
 * auth aboom
 * date 2019-05-24
 */
abstract class WisdaoWallFragment : Fragment(), ILoaderAlbumCall, ILoaderMediaCall {
